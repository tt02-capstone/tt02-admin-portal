...
import { getAttraction } from "../../redux/AttractionRedux";
...
export default function ViewAttractionModal(props) {
    ...
    async function fetchAttraction(vendor, props) {
        console.log("props.attractionId", props.attractionId)
        try {
            let response = await getAttraction(props.attractionId);
